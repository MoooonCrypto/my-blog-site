...
// Placeholder data for a sandbox project
const dummySandboxProject = {
  id: "1",
  title: "Real-time Chat App",
  description: "An experimental project to explore the capabilities of WebSockets for instant, bi-directional communication between clients and a server.",
  technologies: ["Node.js", "Express", "Socket.IO", "React", "TypeScript"],
  github_url: "https://github.com/example/chat-app-sandbox",
  long_description: "<p>This was a weekend project to learn more about real-time technologies. It's not deployed, but the code demonstrates the core concepts of a WebSocket-based chat server and client.</p>",
};
